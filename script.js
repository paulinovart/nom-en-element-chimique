...
const elements = [
    ...
    ["Le Krypton", "Kr", "36", "Gaz nobles", "83,798","Le krypton, gaz noble utilisé dans l’éclairage, partage son nom avec Krypton, la planète natale de Superman dans l’univers DC, dont les fragments après son explosion donnent naissance à la kryptonite, un minéral radioactif capable de l’affaiblir gravement"],
    ...
    ["Le Plomb", "Pb", "82", "Métaux pauvres", "207,2","Le plomb est un métal dense et malléable, largement utilisé dans les batteries, la protection contre les radiations, et dans certains matériaux de construction, bien qu’il soit toxique pour la santé, notamment lorsqu’il est inhalé ou ingéré."],
